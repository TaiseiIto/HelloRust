...
# Put the ssh private key "/root/HelloRust/ssh/github" before the execution.
...
git remote set-url origin git@github.com:TaiseiIto/HelloRust.git
cat gitconfig >> /root/.gitconfig
cat ../ssh/config >> /root/.ssh/config
chmod 600 ../ssh/github
chmod -R 600 /root/.gnupg
/root/.cargo/bin/cargo login $(cat ../crates.io/key)
cd $currentdir
